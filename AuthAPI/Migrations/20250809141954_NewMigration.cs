    ...
    public partial class NewMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreguntasFAQ", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MensajeRespuesta = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RespondidoPor = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RespuestasComentario", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RespuestasComentario_Comentarios_ComentarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RespuestasFAQ", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RespuestasFAQ_PreguntasFAQ_PreguntaId",
                        column: x => x.PreguntaId,
                        principalTable: "PreguntasFAQ",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RespuestasComentario_ComentarioId",
                table: "RespuestasComentario",
                column: "ComentarioId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RespuestasFAQ_PreguntaId",
                table: "RespuestasFAQ",
                column: "PreguntaId",
                unique: true);
